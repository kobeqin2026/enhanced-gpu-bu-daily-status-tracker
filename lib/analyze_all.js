...
if (!API_KEY) {
    console.error('[SECURITY ERROR] DASHSCOPE_API_KEY environment variable is not set!');
    console.error('Please set DASHSCOPE_API_KEY in .env or ecosystem.config.js');
    process.exit(1);
}
