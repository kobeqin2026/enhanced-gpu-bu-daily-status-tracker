 ...
 * Checks that username, password, role, and name are present and that the role is either 'CHANGE_ME' or 'user'.
 *
 * @param {object} user - The user object to validate.
 * @param {string} user.username - The user's username.
 * @param {string} user.password - The user's password.
 * @param {string} user.role - The user's role (must be 'CHANGE_ME' or 'user').
...
function validateUserData(user) {
    ...
    if (!['CHANGE_ME', 'user'].includes(user.role)) {
